...
import pickle
#This allows people to ope, save and edit their list lol.
...
root.title('ToDoList 9.0!')
root.config(bg='pink')
root.resizable(width=False, height=False)

Label(root, text="ToDoList 9.0:", font=('Ubuntu 29 underline'),background="pink").pack(pady=16)
